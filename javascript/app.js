...
$(function () {
		...
		var loginValidationSettings = {
			...
			messages: {
				...
				agree: "Merci d'accepter notre politique"
			},
			invalidHandler: function () {
				animate({
					name: 'shake',
...
$(function () {
	...
	var signupValidationSettings = {
		...
		messages: {
			firstname: "Merci d'entrer votre nom et votre prénom",
			lastname: "Merci d'entrer votre nom et votre prénom",
			email: {
			...
			password: {
				...
				minlength: "Votre mot de passe doit contenir obligatoirement 8 caractères."
			},
			retype_password: {
				required: "Merci d'entrer votre mot de passe.",
				minlength: "Votre mot de passe doit contenir obligatoirement 8 caractères."
			},
			agree: "Veuillez accepter les termes de notre charte"
		},
		invalidHandler: function () {
			animate({
				name: 'shake',
...
$(function () {
	...
	function setThemeState() {
		...
		if (themeSettings.themeName) {
			$styleLink.attr('href', '/../formation-dev/agenda/css/app-' + themeSettings.themeName + '.css');
		} else {
			$styleLink.attr('href', '/../formation-dev/agenda/css/app.css');
		}
