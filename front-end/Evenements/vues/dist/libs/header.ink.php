					...
					<ul class="nav-profile">
    			     ...
    			     Stéphanie 
							...
							<div class="dropdown-menu profile-dropdown-menu" aria-labelledby="dropdownMenu1">
								...
								<a class="dropdown-item" href="login.php"> <i class="fa fa-power-off icon"></i> Login </a>
							</div>
						</li>
					</ul>
				</div>
			...
			<aside class="sidebar">
				<div class="sidebar-container">
					<div class="sidebar-header">
						<div class="brand">
							<div class="logo"> <span class="l l1"></span> <span class="l l2"></span> <span class="l l3"></span> <span class="l l4"></span> <span class="l l5"></span> </div><a href="index.php"> &nbsp;Administration</a></div>
					</div>
					<nav class="menu">
						<ul class="nav metismenu" id="sidebar-menu">
							<li class="active">
								<a href="index.php"> <i class="fa fa-home"></i>Tableau de bord</a>
							</li>
							<li>
								<a href=""> <i class="fa fa-th-large"></i>Evènements<i class="fa arrow"></i> </a>
								<ul>
									<li> <a href="items-list.php">Listes </a></li>
									<li><a href="item-editor.php">Traitements</a></li>
								</ul>
							</li>
							<!--
							<li>
