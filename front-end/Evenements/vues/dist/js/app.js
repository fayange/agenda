...
$(function () {
	...
	function s() {
		return e.themeName ? t.attr("href", "css/app-" + e.themeName + ".css") : t.attr("href", "css/app.css"), r.removeClass("header-fixed footer-fixed sidebar-fixed"), r.addClass(e.headerPosition), r.addClass(e.footerPosition), r.addClass(e.sidebarPosition), r
	}
