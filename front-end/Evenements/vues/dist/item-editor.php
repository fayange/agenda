<?php include("libs/header.ink.php"); ?>
	<article class="content item-editor-page">
		<div class="title-block">
			<h3 class="title"> Ajouter un nouvel évènement <span class="sparkline bar" data-type="bar"></span> </h3>
		</div>
		...
		<form name="item">
			<div class="card card-block">
				<div class="form-group row">
					...
					<div class="input-group col-sm-10">
						<input type="text" id="timeformatExample1" class="form-control time ui-timepicker-input" name="start" placeholder="Heure de début" autocomplete="off" />
						<span class="input-group-addon"></span>
						<input type="text" id="timeformatExample2" class="form-control time ui-timepicker-input" name="start" placeholder="Heure de début" autocomplete="off" />
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control boxed" placeholder="Titre" id="titre"> </div>
					</div>
			...
			<span title="Link" class="ql-format-button ql-link"></span> <span class="ql-format-separator"></span>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control boxed" placeholder="commissions" id="commissions"> </div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2 form-control-label text-xs-right" for="titre"> Ordre du jour :
						</label>
						<div class="col-sm-10">
							<input type="text" class="form-control boxed" placeholder="ordredejour" id="ordredujour"> </div>
					</div>
					<br>
					<br>
					<br>
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control boxed" placeholder="lieu" id="lieu"> </div>
					</div>
					<div class="form-group row">
						...
						<br>
						<div class="col-sm-10">
							<input type="text" class="form-control boxed" placeholder="Places disponibles" id="placesdispos"> </div>
					</div>
