		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<br>			
						<?php
								foreach($events->tabPublic as $event){?>
					<div class="col-md-4">	
							<img src="../Evenements/vues/public.jpg" alt="" width="100%">
						<br>
						<br>
						<br>
						...
						<br>
						<p><span class="under">lieu:</span>
							<?php echo $event["lieu"]; ?>
						</p>
						<p><span class="under">places Disponibles :</span>
