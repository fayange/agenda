...
//		$events->selectPublic();	
		...
		$vue = "../Evenements/vues/vue-evenementspublicsAll.php";
		
		}
		else{
//		$events->selectPrive();	
		$titre = "Liste des évènements privés";
		$vue = "../Evenements/vues/vue-evenementsprivesAll.php";
			}
...
if(isset($_GET["type"])&& $_GET["type"] == "tous"){
		...
		$vue = "../Evenements/vues/all.php";
}
//var_dump($events);
#$agenda->addEvenement($ttLesEvenements);
